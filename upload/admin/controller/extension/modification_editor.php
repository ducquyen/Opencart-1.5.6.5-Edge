...
class ControllerExtensionModificationEditor extends Controller {
	public function index() {
		...
		if (isset($this->request->get['modification_id'])) {
			...
			if ($modification_info) {
				$this->data['modification_id'] = $modification_id;
				$this->data['name'] = $modification_info['name'];
				$this->data['xml'] = $modification_info['xml'];
			...
			$this->data['modification_id'] = 0;
			$this->data['name'] = $this->language->get('text_new');
			$this->data['xml'] = '';
		...
		$this->data['entry_xml_code'] = $this->language->get('entry_xml_code');

		$this->data['text_loading'] = $this->language->get('text_loading');
		$this->data['text_erasing'] = $this->language->get('text_erasing');

		$this->data['button_clear_data']  = $this->language->get('button_clear_data');
		$this->data['button_clear_image'] = $this->language->get('button_clear_image');
		...
		$this->data['return'] = $this->url->link('extension/modification', 'token=' . $this->session->data['token'], 'SSL');
		
		$this->data['refresh'] = $this->url->link('extension/modification/refresh', 'token=' . $this->session->data['token'], 'SSL');
		
		$this->data['token'] = $this->session->data['token'];
		
		$this->template = 'extension/modification_editor.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function refresh() {
		if (!$this->user->hasPermission('modify', 'extension/modification_editor')) {
			$this->response->redirect($this->url->link('extension/modification_editor', 'token=' . $this->session->data['token'], 'SSL'));
		}
