...
class ControllerCatalogAttributeGroup extends Controller { 
	...
	protected function getList() {
		...
		$this->data['results'] = sprintf($this->language->get('text_pagination'), ($attribute_group_total) ? (($page - 1) * $this->config->get('config_admin_limit')) + 1 : 0, ((($page - 1) * $this->config->get('config_admin_limit')) > ($attribute_group_total - $this->config->get('config_admin_limit'))) ? $attribute_group_total : ((($page - 1) * $this->config->get('config_admin_limit')) + $this->config->get('config_admin_limit')), $attribute_group_total, ceil($attribute_group_total / $this->config->get('config_admin_limit')));
